...
directory_path = "/Users/usamasaleem/School/Fall 2023/Capstone/Awaazo/docs"

# Get the list of files in the directory
file_names = os.listdir(directory_path)

# Print the names of the documents in order
...
if len(sys.argv) > 2:
    ...
    dialog_count = int(input("How many dialogs do you want? [default 5]\n") or "5")
