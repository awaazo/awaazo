...
const componentsData = [
  ...
  { component: <Bookmarks bookmarks={currentEpisode.bookmarks} />, isVisible: true },
  { component: <Transcripts transcripts={currentEpisode.transcript} />, isVisible: true },
  { component: <Sections sections={currentEpisode.sections} />, isVisible: true },
];
...
const NowPlaying = () => {
  ...
  const [components, setComponents] = useState(() => componentsData.map((component, index) => ({
    ...component,
