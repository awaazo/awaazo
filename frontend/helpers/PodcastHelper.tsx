...
export default class PodcastHelper {
   ...
   * @returns A BaseResponse object with the server's response.
   */
  public static podcastGetRecentPodcasts = async (page, pageSize): Promise<AllPodcastResponse> => {
    // Create the request options.
    const options = {
      method: 'Get',
    ...
    try {
      ...
      console.log('Received the following podcastGetRecentPodcasts... \n' + requestResponse)
   ...
   * @returns A BaseResponse object with the server's response.
   */
  public static podcastGetRecentEpisodes = async (page, pageSize): Promise<AllEpisodeResponse> => {
    // Create the request options.
    const options = {
      method: 'Get',
  ...
  public static episodeAddAudioRequest = async (
    requestData: EpisodeAddAudioRequest,
    episodeId: string,
    onUploadProgress: (progressEvent: AxiosProgressEvent) => void // Use AxiosProgressEvent here
  ): Promise<EpisodeAddAudioResponse> => {
    // Create the request options.
    const options: AxiosRequestConfig = {
      method: 'POST',
      data: requestData,
      url: EndpointHelper.getPodcastEpisodeAddAudioEndpoint(episodeId),
      headers: {
        accept: '*/*',
        'Content-Type': 'multipart/form-data',
      },
    ...
    try {
      console.debug('Sending the following episodeAddAudioRequest...')
      console.debug(options)
      ...
      console.debug('Received the following episodeAddAudioResponse...')
      console.debug(requestResponse)
   ...
   * @returns A BaseResponse object with the server's response.
   */
  public static editTranscriptLines = async (episodeId, requestData: editTranscriptLinesRequest): Promise<BaseResponse> => {
    const options = {
      method: 'POST',
      headers: {
        accept: '*/*',
   ...
   * @returns A BaseResponse object with the server's response.
   */
  public static getTranscriptText = async (episodeId): Promise<GetTranscriptTextResponse> => {
    const options = {
      method: 'GET',
      headers: {
        accept: '*/*',
