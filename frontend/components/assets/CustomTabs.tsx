      ...
      <TabList mb="1em">
        <HStack spacing="0.5em">
          {tabItems.map((item, index) => (
            <Tab key={item.label}>
              <Box display="flex" flexDirection="row" alignItems="center" justifyContent="center" _hover={{ color: 'az.red', transition: 'color 0.5s ease-in-out' }} transition="color 0.5s ease-in-out">
