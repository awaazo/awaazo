  ...
  return (
    <>
      <Box
        ...
        border={colorMode === "dark" ? "3px solid rgba(255, 255, 255, 0.05)" : "3px solid rgba(0, 0, 0, 0.05)"}
      >
        <Flex alignItems={"center"} justifyContent={"space-between"} px={6}>
          ...
          {isMobile ? (
            <Flex alignItems={"center"}>
              <IconButton aria-label="Search" icon={<SearchIcon />} onClick={handleSearchSubmit} variant="ghost" size="md" rounded={"full"} opacity={0.9} mr={4} 
            ...
            >
              ...
              />
              <Link href="/Create">
                <Button colorScheme="teal" variant="ghost" size="md" rounded={"full"} opacity={0.9} mr={4} color={colorMode === "dark" ? "white" : "black"} 
