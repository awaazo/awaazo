...
import { FaPlay, FaPause, FaHeart, FaCommentAlt, FaBackward, FaForward, FaVolumeDown, FaVolumeUp, FaStepForward, FaStepBackward } from "react-icons/fa";
import { Episode } from "../../utilities/Interfaces";
import { convertTime } from "../../utilities/commonUtils"

function PlayerBar(props) {
  const { coverArt, episodeName = "Unknown Episode", podcaster = "Unknown Podcaster", duration, likes, comments, sections = [] } = props;
