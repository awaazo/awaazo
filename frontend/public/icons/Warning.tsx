...
const SvgWarning = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 18 18" {...props}>
    <path fill="currentColor" d="M13.404 2.702C11.447-.9 6.553-.9 4.596 2.702L.688 9.9C-1.268 13.5 1.178 18 5.092 18h7.816c3.913 0 6.36-4.5 4.404-8.101l-3.908-7.197Z" />
    <path
      fill="#393939"
