...
const SvgOneDot = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 71 22" {...props}>
    ...
    />
    <path fill="currentColor" d="M21.574 22.176c2.52 0 4.562-2.08 4.562-4.645 0-2.565-2.042-4.645-4.562-4.645-2.519 0-4.561 2.08-4.561 4.645 0 2.566 2.042 4.645 4.561 4.645Z" />
    <defs>
