describe("Playlists", () => {
    ...
    it("Should not show any playlists if none are present", function () {
        ...
        cy.get('body').contains('You have no playlists');
    ...
    it("Should edit a playlist name & description", function () {
        ...
        cy.get('input[placeholder="Enter Playlist Name"]').type(" (EDIT)");
        cy.get('body').contains('Temp Description').type(" (EDIT)");
        cy.get('button').contains('Update Playlist Info').click();
    ...
    it("Should cancel the edit by clicking the cancel button", function () {
        ...
        cy.get('input[placeholder="Enter Playlist Name"]').type(" (CANCEL)");
        cy.get('body').contains('Temp Description').type(" (CANCEL)");
